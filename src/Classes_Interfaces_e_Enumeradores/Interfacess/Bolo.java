package Classes_Interfaces_e_Enumeradores.Interfacess;

import java.util.Date;

public class Bolo extends Object implements Assavel{
    ...
    @Override
    public void assar(int temperatura) {
        assarBolo(temperatura);
    }
